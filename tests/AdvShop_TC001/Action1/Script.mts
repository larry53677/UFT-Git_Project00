...
Browser("Advantage Shopping").Page("Advantage Shopping").Link("MANUFACTURER").Click @@ script infofile_;_ZIP::ssf6.xml_;_
Browser("Advantage Shopping").Page("Advantage Shopping").WebCheckBox("manufacturer_0").Set "ON" @@ script infofile_;_ZIP::ssf7.xml_;_
